...
# ============================================================
# 6. Convert one mask to YOLO bounding boxes
# ============================================================
...
# ============================================================
# 7. Generate YOLO labels for all mask tiles
# ============================================================
...
def create_yolo_labels(
    ...
    """
    Generate YOLO .txt label files for all mask tiles.
    """
    ...
    for split_name in ["train", "val", "test"]:
        ...
        print(f"\nCreating YOLO labels for {split_name}...")
...
def visualize_random_samples(
    ...
    3. original image with YOLO bounding boxes
    ...
    for image_path in selected_images:
        ...
        # so it can be concatenated with the RGB/BGR images.
        ...
        # ----------------------------------------------------
        # Copy image for bounding-box visualization
        # ----------------------------------------------------
        ...
        if label_path.exists():
            ...
            for line in lines:
                ...
                # --------------------------------------------
                # Convert YOLO coordinates back to pixels
                # --------------------------------------------
...
def main():
    ...
    # --------------------------------------------------------
    # Step 4:
    # Convert tiled masks into YOLO bounding-box labels
    # --------------------------------------------------------
